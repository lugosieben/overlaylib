...
public class OverlayVertexHelper {
    ...
    public static void vertex(
        ...
        buffer.addVertex(x, y, z).setColor(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha()).setUv(u, v);
    }
    ...
    public static void triangle(
        ...
        vertex(buffer, x1, y1, z1, color, uv[0], uv[1]);
        if (rotation == UVRotation.CW_90 || rotation == UVRotation.CW_270) {
            // 90/270 needs swapped edges to prevent mirroring
            vertex(buffer, x2, y2, z2, color, uv[2], uv[1]);
            vertex(buffer, x3, y3, z3, color, uv[2], uv[3]);
        } else {
            vertex(buffer, x2, y2, z2, color, uv[0], uv[3]);
            vertex(buffer, x3, y3, z3, color, uv[2], uv[3]);
        }
    }
    ...
    public static void rect(
        ...
        triangle(buffer, p1[0], p1[1], p1[2], p2[0], p2[1], p2[2], p3[0], p3[1], p3[2], color, uStart, vStart, uEnd, vEnd, rotation);
        triangle(buffer, p3[0], p3[1], p3[2], p4[0], p4[1], p4[2], p1[0], p1[1], p1[2], color, uEnd, vEnd, uStart, vStart, rotation);
    }
    ...
    public static void square(
        ...
        square(buffer, fixedAxis, fixedCoord, firstAxisStart, secondAxisStart, 1f, color, uStart, vStart, uEnd, vEnd, rotation);
    }
